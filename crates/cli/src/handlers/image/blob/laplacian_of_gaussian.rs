use clap::ArgMatches;
use picturify_pipeline::blob::laplacian_of_gaussian::{LaplacianOfGaussianPipeline, LaplacianOfGaussianPipelineOptions};
use crate::commands::common::args::common::{FastArg, PicturifyArg};
use crate::commands::image::blob::laplacian_of_gaussian::{LaplacianOfGaussianRadiusArg, LaplacianOfGaussianSigmaArg};
...
impl CommandHandler for LaplacianOfGaussianCommandHandler {
    fn handle(&self, args: ArgMatches) -> CliPicturifyResult<()> {
        ...
        let radius = args.get_one::<usize>(LaplacianOfGaussianRadiusArg::id()).unwrap();
        let sigma = args.get_one::<f32>(LaplacianOfGaussianSigmaArg::id()).unwrap();
