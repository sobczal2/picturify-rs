use image::Rgba;
use palette::{Clamp, FromColor, IntoColor, LinSrgba, Srgba, WithAlpha};
...
pub trait ApplyFnToPalettePixels {
    ...
    {
        self.apply_fn_to_linsrgba(|pixel, x, y| {
            run_on_linsrgba_pixel(pixel, x, y, &f)
        });
    }
